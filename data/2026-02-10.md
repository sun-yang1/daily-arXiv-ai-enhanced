...
TL;DR: Proposes an attribution-based method to align model decisions with human priors, improving accuracy and reasonability in classification and generation tasks.


<details>
  <summary>Details</summary>
Motivation: Conventional supervised learning often leads models to achieve high accuracy through shortcut correlations rather than intended evidence, diverging from human perception. Human priors can constrain this behavior but aligning models to these priors is challenging.

Method: An attribution-based human prior alignment method is proposed, encoding human priors as input regions (e.g., bounding boxes) and using a subset-selection-based attribution approach to expose the model's decision evidence during training. Penalties are applied when the attribution region deviates from the prior regions.

Result: The method is validated on image classification and click decision tasks in MLLM-based GUI agent models, showing improved accuracy and decision reasonability.

Conclusion: Human prior alignment consistently improves task accuracy and enhances the model's decision reasonability across conventional classification and autoregressive generation settings.
...
### [2] [Vectra: A New Metric, Dataset, and Model for Visual Quality Assessment in E-Commerce In-Image Machine Translation](https://arxiv.org/abs/2602.07014)
*Qingyu Wu,Yuxuan Han,Haijun Li,Zhao Xu,Jianshan Zhao,Xu Jin,Longyue Wang,Weihua Luo*

Main category: cs.CV

TL;DR: Vectra is a reference-free, MLLM-driven visual quality assessment framework for e-commerce IIMT, achieving state-of-the-art performance in human ranking correlation and outperforming leading MLLMs.


<details>
  <summary>Details</summary>
Motivation: Existing reference-based methods lack explainability, and model-as-judge approaches lack domain-grounded, fine-grained reward signals for visual quality assessment in e-commerce IIMT.

Method: Vectra comprises three components: Vectra Score (a multidimensional quality metric system), Vectra Dataset (constructed from 1.1M real-world product images), and Vectra Model (a 4B-parameter MLLM).

Result: Vectra demonstrates superior correlation with human rankings and outperforms leading MLLMs in scoring performance.

Conclusion: Vectra achieves state-of-the-art correlation with human rankings and outperforms leading MLLMs like GPT-5 and Gemini-3 in scoring performance. The dataset and model will be released upon acceptance.
...
### [3] [Robust and Real-Time Bangladeshi Currency Recognition: A Dual-Stream MobileNet and EfficientNet Approach](https://arxiv.org/abs/2602.07015)
*Subreena,Mohammad Amzad Hossain,Mirza Raquib,Saydul Akbar Murad,Farida Siddiqi Prity,Muhammad Hanif,Nick Rahimi*

Main category: cs.CV

TL;DR: A hybrid CNN model for currency recognition achieves high accuracy and transparency, aiding visually impaired individuals.


<details>
  <summary>Details</summary>
Motivation: To address the dependency of visually impaired individuals on others for currency recognition, which exposes them to fraud and exploitation.

Method: A novel hybrid CNN architecture combining MobileNetV3-Large and EfficientNetB0 for feature extraction, followed by an MLP classifier. The model is evaluated using five-fold cross-validation and seven metrics.

Result: The model achieves high accuracy across different datasets (97.95%, 92.84%, and 94.98%) and is evaluated using multiple metrics and explainable AI methods.

Conclusion: The proposed hybrid CNN architecture achieves high accuracy (97.95% on controlled datasets, 92.84% on complex backgrounds, and 94.98% overall) and is suitable for resource-constrained devices. The use of explainable AI methods enhances transparency.
...
### [4] [XAI-CLIP: ROI-Guided Perturbation Framework for Explainable Medical Image Segmentation in Multimodal Vision-Language Models](https://arxiv.org/abs/2602.07017)
*Thuraya Alzubaidi,Sana Ammar,Maryam Alsharqi,Islem Rekik,Muzammil Behzad*

Main category: cs.CV

TL;DR: XAI-CLIP is an ROI-guided perturbation framework that improves interpretability and efficiency in medical image segmentation by leveraging multimodal vision-language embeddings.


<details>
  <summary>Details</summary>
Motivation: The limited interpretability of transformer-based models in medical image segmentation hinders clinical trust and deployment. Existing XAI techniques are computationally expensive and produce noisy explanations.

Method: XAI-CLIP integrates language-informed region localization with medical image segmentation and applies targeted, region-aware perturbations to generate clearer saliency maps.

Result: XAI-CLIP achieves a 60% reduction in runtime, a 44.6% improvement in dice score, and a 96.7% increase in Intersection-over-Union for occlusion-based explanations compared to conventional methods.

Conclusion: The proposed XAI-CLIP framework significantly enhances interpretability and efficiency in medical image segmentation, making it more clinically deployable.
...
### [5] [Deep Learning Based Multi-Level Classification for Aviation Safety](https://arxiv.org/abs/2602.07019)
*Elaheh Sabziyan Varnousfaderani,Syed A. M. Shihab,Jonathan King*

Main category: cs.CV

TL;DR: Proposes an image-based bird classification framework using CNNs to enhance aviation safety by identifying bird species, flock formation, and size for better flight path prediction.


<details>
  <summary>Details</summary>
Motivation: Bird strikes are a significant threat to aviation safety, and existing radar systems lack the ability to identify bird species, which is crucial for accurate flight behavior prediction.

Method: Uses Convolutional Neural Networks (CNNs) for species identification, flock formation type, and size estimation, integrated with camera systems for autonomous visual detection.

Result: The framework provides species-specific predictive models and supplementary information (flock type and size) to improve flight path prediction and assess potential impact severity.

Conclusion: The proposed CNN-based approach addresses limitations of current systems by enabling detailed bird characterization, enhancing aviation safety through more accurate risk assessment.
...
### [6] [The Geometry of Representational Failures in Vision Language Models](https://arxiv.org/abs/2602.07025)
*Daniele Savietto,Declan Campbell,André Panisson,Marco Nurisso,Giovanni Petri,Jonathan D. Cohen,Alan Perotti*

Main category: cs.CV

TL;DR: Analysis of Vision-Language Models (VLMs) reveals mechanistic insights into their failures in multi-object tasks, linking representational geometry to error patterns.


<details>
  <summary>Details</summary>
Motivation: VLMs exhibit puzzling failures in multi-object tasks, similar to human cognitive constraints like the 'Binding Problem,' but the internal mechanisms are poorly understood.

Method: Analyzed the representational geometry of open-weight VLMs (Qwen, InternVL, Gemma) to distill 'concept vectors' and validated them via steering interventions.

Result: Geometric overlap between concept vectors correlates with specific error patterns, providing a quantitative framework to understand VLM behavior.

Conclusion: The study offers a mechanistic understanding of how internal representations in VLMs drive visual failures, bridging gaps in artificial cognitive systems.
...
### [7] [Modality Gap-Driven Subspace Alignment Training Paradigm For Multimodal Large Language Models](https://arxiv.org/abs/2602.07026)
...
TL;DR: The paper proposes ReAlign and ReVision to address the Modality Gap, enabling efficient scaling of MLLMs using unpaired data.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the persistent geometric anomaly, the Modality Gap, where embeddings of distinct modalities expressing identical semantics occupy systematically offset regions. Prior approaches are limited by oversimplified isotropic assumptions, hindering large-scale application.

Method: The paper introduces ReAlign, a training-free modality alignment strategy, and ReVision, a scalable training paradigm for MLLMs. ReAlign aligns text representation into the image representation distribution via a three-step process (Anchor, Trace, and Centroid Alignment). ReVision integrates ReAlign into the pretraining stage.

Result: The framework demonstrates that ReAlign and ReVision can efficiently scale MLLMs by leveraging unpaired data, eliminating the need for large-scale, high-quality image-text pairs.

Conclusion: The paper concludes that statistically aligned unpaired data can effectively substitute for expensive image-text pairs, providing a robust path for efficient scaling of Multimodal Large Language Models (MLLMs).
...
### [8] [Fair Context Learning for Evidence-Balanced Test-Time Adaptation in Vision-Language Models](https://arxiv.org/abs/2602.07027)
*Sanggeon Yun,Ryozo Masukawa,SungHeon Jeong,Wenjun Huang,Hanning Chen,Mohsen Imani*

Main category: cs.CV

TL;DR: FCL is a novel episodic TTA framework that avoids entropy minimization by addressing shared-evidence bias, achieving competitive performance across diverse benchmarks.


<details>
  <summary>Details</summary>
Motivation: Vision-Language Models (VLMs) such as CLIP enable strong zero-shot recognition but suffer substantial degradation under distribution shifts. Test-Time Adaptation (TTA) aims to improve robustness using only unlabeled test samples, yet most prompt-based TTA methods rely on entropy minimization -- an approach that can amplify spurious correlations and induce overconfident errors when classes share visual features.

Method: FCL decouples adaptation into (i) augmentation-based exploration to identify plausible class candidates, and (ii) fairness-driven calibration that adapts text contexts to equalize sensitivity to common visual evidence.

Result: FCL mitigates partial feature obsession and enables effective calibration of text embeddings without relying on entropy reduction.

Conclusion: FCL achieves competitive adaptation performance relative to state-of-the-art TTA methods across diverse domain-shift and fine-grained benchmarks.
...
### [9] [A Comparative Study of Adversarial Robustness in CNN and CNN-ANFIS Architectures](https://arxiv.org/abs/2602.07028)
*Kaaustaaub Shankar,Bharadwaj Dogga,Kelly Cohen*

Main category: cs.CV

TL;DR: ANFIS-augmented CNNs show mixed robustness results, improving some architectures (ResNet18) but not others (VGG).


<details>
  <summary>Details</summary>
Motivation: Convolutional Neural Networks (CNNs) achieve strong image classification performance but lack interpretability and are vulnerable to adversarial attacks. Neuro-fuzzy hybrids such as DCNFIS replace fully connected CNN classifiers with Adaptive Neuro-Fuzzy Inference Systems (ANFIS) to improve interpretability, yet their robustness remains underexplored.

Method: This work compares standard CNNs (ConvNet, VGG, ResNet18) with their ANFIS-augmented counterparts on MNIST, Fashion-MNIST, CIFAR-10, and CIFAR-100 under gradient-based (PGD) and gradient-free (Square) attacks.

Result: Results show that ANFIS integration does not consistently improve clean accuracy and has architecture-dependent effects on robustness: ResNet18-ANFIS exhibits improved adversarial robustness, while VGG-ANFIS often underperforms its baseline.

Conclusion: Neuro-fuzzy augmentation can enhance robustness in specific architectures but is not universally beneficial.
...
### [10] [UNIKIE-BENCH: Benchmarking Large Multimodal Models for Key Information Extraction in Visual Documents](https://arxiv.org/abs/2602.07038)
*Yifan Ji,Zhipeng Xu,Zhenghao Liu,Zulong Chen,Qian Zhang,Zhibo Yang,Junyang Lin,Yu Gu,Ge Yu,Maosong Sun*

Main category: cs.CV

TL;DR: UNIKIE-BENCH is introduced to evaluate LMMs' KIE capabilities, revealing challenges in accuracy and layout-aware reasoning across diverse scenarios.


<details>
  <summary>Details</summary>
Motivation: Key Information Extraction (KIE) from real-world documents is challenging due to variations in layout structures, visual quality, and task-specific requirements. Recent LMMs show potential for end-to-end KIE, but a comprehensive evaluation benchmark is needed.

Method: The paper introduces UNIKIE-BENCH, a unified benchmark with two tracks: constrained-category KIE and open-category KIE, to evaluate the KIE capabilities of LMMs across diverse scenarios.

Result: Experiments on 15 state-of-the-art LMMs reveal significant performance degradation under diverse schema definitions, long-tail key fields, and complex layouts, with notable disparities across document types and scenarios.

Conclusion: The study highlights the persistent challenges in grounding accuracy and layout-aware reasoning for LMM-based KIE, despite the promising potential of recent Large Multimodal Models.
...
### [11] [OMNI-Dent: Towards an Accessible and Explainable AI Framework for Automated Dental Diagnosis](https://arxiv.org/abs/2602.07041)
...
### [12] [COMBOOD: A Semiparametric Approach for Detecting Out-of-distribution Data for Image Classification](https://arxiv.org/abs/2602.07042)
*Magesh Rajasekaran,Md Saiful Islam Sajol,Frej Berglind,Supratik Mukhopadhyay,Kamalika Das*

Main category: cs.CV

TL;DR: COMBOOD is a novel semi-parametric framework for OOD detection that combines nearest-neighbor and Mahalanobis metrics, achieving superior accuracy in both near-OOD and far-OOD scenarios.


<details>
  <summary>Details</summary>
Motivation: Identifying out-of-distribution (OOD) data is crucial for reliable machine learning applications, especially in automation. Existing methods struggle with near-OOD scenarios, prompting the need for a more robust solution.

Method: The COMBOOD framework combines nearest-neighbor (non-parametric) and Mahalanobis (parametric) distance metrics in a semi-parametric setting to derive a confidence score for OOD detection.

Result: COMBOOD outperforms state-of-the-art methods on OpenOOD benchmarks (v1 and v1.5) and document datasets, with statistically significant accuracy improvements.

Conclusion: COMBOOD significantly improves OOD detection accuracy across both near-OOD and far-OOD scenarios, outperforming state-of-the-art methods on benchmark datasets. Its linear scalability makes it suitable for real-life applications.
...
### [13] [PipeMFL-240K: A Large-scale Dataset and Benchmark for Object Detection in Pipeline Magnetic Flux Leakage Imaging](https://arxiv.org/abs/2602.07044)
*Tianyi Qu,Songxiao Yang,Haolin Wang,Huadong Song,Xiaoting Guo,Wenguang Hu,Guanlin Liu,Honghe Chen,Yafei Ou*

Main category: cs.CV

TL;DR: Introduction of PipeMFL-240K, a large-scale dataset for pipeline MFL inspection, addressing challenges like long-tailed distribution, tiny objects, and intra-class variability. It provides a benchmark for future research.


<details>
  <summary>Details</summary>
Motivation: The absence of a large-scale public dataset and benchmark for MFL interpretation hinders progress in reliable deep learning models for pipeline integrity assessment.

Method: Creation of PipeMFL-240K, a dataset with 240,320 images and 191,530 annotations from 11 pipelines, designed to reflect real-world inspection complexity.

Result: Modern detectors struggle with MFL data properties, indicating room for improvement, while PipeMFL-240K offers a reliable testbed for future research.

Conclusion: PipeMFL-240K is a critical foundation for pipeline diagnostics and maintenance, expected to accelerate algorithmic innovation in MFL-based integrity assessment.
...
### [14] [VLRS-Bench: A Vision-Language Reasoning Benchmark for Remote Sensing](https://arxiv.org/abs/2602.07045)
*Zhiming Luo,Di Wang,Haonan Guo,Jing Zhang,Bo Du*

Main category: cs.CV

TL;DR: VLRS-Bench is the first benchmark dedicated to complex RS reasoning, structured across Cognition, Decision, and Prediction, revealing limitations in current MLLMs.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the limitation of existing RS benchmarks, which are heavily biased toward perception tasks, hindering the development of MLLMs for cognitively demanding RS applications.

Method: The authors propose VLRS-Bench, a benchmark structured across Cognition, Decision, and Prediction dimensions, comprising 2,000 question-answer pairs with an average length of 71 words, spanning 14 tasks and up to eight temporal phases. It is constructed via a specialized pipeline integrating RS-specific priors and expert knowledge.

Result: Experimental results reveal significant bottlenecks in existing state-of-the-art MLLMs, providing critical insights for advancing multimodal reasoning in remote sensing.

Conclusion: The paper concludes that VLRS-Bench addresses the gap in complex reasoning benchmarks for remote sensing, revealing significant limitations in current MLLMs and providing a foundation for future advancements in multimodal reasoning within the RS community.
...
### [15] [ShapBPT: Image Feature Attributions Using Data-Aware Binary Partition Trees](https://arxiv.org/abs/2602.07047)
*Muhammad Rashid,Elvio G. Amparore,Enrico Ferrari,Damiano Verda*

Main category: cs.CV

TL;DR: ShapBPT introduces a data-aware XCV method using hierarchical Shapley values tailored for images, improving efficiency and alignment with image morphology.


<details>
  <summary>Details</summary>
Motivation: Existing hierarchical Shapley approaches do not exploit the multiscale structure of image data, leading to slow convergence and weak alignment with actual morphological features.

Method: ShapBPT assigns Shapley coefficients to a multiscale hierarchical structure tailored for images, the Binary Partition Tree (BPT), ensuring alignment with intrinsic image morphology.

Result: ShapBPT demonstrates superior alignment with image structures and improved efficiency over existing XCV methods, with a 20-subject user study confirming human preference for ShapBPT explanations.

Conclusion: ShapBPT provides a more efficient and semantically meaningful approach to visual interpretability, with experimental results confirming its effectiveness and human preference.
...
### [16] [Enhancing IMU-Based Online Handwriting Recognition via Contrastive Learning with Zero Inference Overhead](https://arxiv.org/abs/2602.07049)
*Jindong Li,Dario Zanca,Vincent Christlein,Tim Hamann,Jens Barth,Peter Kämpf,Björn Eskofier*

Main category: cs.CV

TL;DR: ECHWR is a training framework for online handwriting recognition on edge hardware, improving accuracy without increasing inference costs by using a dual contrastive objective and discarding the auxiliary branch post-training.


<details>
  <summary>Details</summary>
Motivation: To address memory constraints and improve privacy and latency in online handwriting recognition on edge hardware.

Method: Proposes ECHWR, which uses a temporary auxiliary branch with a dual contrastive objective (in-batch and error-based contrastive losses) to align sensor signals with semantic text embeddings during training.

Result: Significantly outperforms state-of-the-art baselines, reducing character error rates by up to 7.4% (writer-independent) and 10.4% (writer-dependent) on the OnHW-Words500 dataset.

Conclusion: Error-based contrastive loss effectively handles unseen writing styles, though specific challenges require tailored architectural and objective configurations.
...
### [17] [Interpreting Physics in Video World Models](https://arxiv.org/abs/2602.07050)
*Sonia Joseph,Quentin Garrido,Randall Balestriero,Matthew Kowal,Thomas Fel,Shahab Bakhtiari,Blake Richards,Mike Rabbat*

Main category: cs.CV

TL;DR: The study reveals that video models use distributed representations of physical variables, not factorized ones, with a distinct Physics Emergence Zone where these variables become accessible.


<details>
  <summary>Details</summary>
Motivation: To determine whether video-based models rely on factorized representations of physical variables or implicitly represent them in a task-specific, distributed manner.

Method: Layerwise probing, subspace geometry, patch-level decoding, and targeted attention ablations were used to examine physical representations in large-scale video encoders.

Result: Identified a Physics Emergence Zone where physical variables become accessible, with scalar quantities like speed and acceleration available early, while motion direction becomes accessible later and is encoded through a high-dimensional population structure with circular geometry.

Conclusion: Modern video models use a distributed representation of physical variables rather than factorized representations, which is sufficient for making physical predictions.
...
### [18] [Neural Sentinel: Unified Vision Language Model (VLM) for License Plate Recognition with Human-in-the-Loop Continual Learning](https://arxiv.org/abs/2602.07051)
*Karthik Sivakoti*

Main category: cs.CV

TL;DR: Neural Sentinel introduces a unified VLM-based approach for ALPR, achieving higher accuracy and multi-task capabilities compared to traditional multi-stage pipelines.


<details>
  <summary>Details</summary>
Motivation: Traditional ALPR systems suffer from compounding errors, latency, and complexity due to their multi-stage pipeline design.

Method: The research fine-tunes a PaliGemma 3B model using LoRA and incorporates a Human-in-the-Loop continual learning framework with experience replay.

Result: Achieves 92.3% plate recognition accuracy (14.1% improvement over EasyOCR), 152ms mean latency, and ECE of 0.048. Also enables zero-shot generalization to auxiliary tasks.

Conclusion: Unified VLM approaches represent a paradigm shift in ALPR, offering superior accuracy, reduced complexity, and emergent multi-task capabilities.
...
### [19] [Toward Accurate and Accessible Markerless Neuronavigation](https://arxiv.org/abs/2602.07052)
...
TL;DR: The paper introduces a markerless neuronavigation system using low-cost cameras and algorithmic modeling, showing improved accuracy and comfort over traditional marker-based systems.


<details>
  <summary>Details</summary>
Motivation: Traditional neuronavigation systems rely on subject-mounted markers, which are uncomfortable, prone to shifting, and require manual registration.

Method: The study uses visible and infrared light cameras with stereo and depth sensing combined with facial geometry modeling to create a markerless system.

Result: Validation with 50 human subjects showed a median tracking discrepancy of 2.32 mm and 2.01°, indicating sufficient accuracy for transcranial magnetic stimulation.

Conclusion: The markerless approach reduces cost and complexity, improves patient comfort, and expands access to neuronavigation in clinical and research settings.
...
### [20] [RECITYGEN -- Interactive and Generative Participatory Urban Design Tool with Latent Diffusion and Segment Anything](https://arxiv.org/abs/2602.07057)
*Di Mo,Mingyang Sun,Chengxiu Yin,Runjia Tian,Yanhong Wu,Liyan Xu*

Main category: cs.CV

TL;DR: RECITYGEN is a novel tool combining latent diffusion models and interactive semantic segmentation to enable participatory urban design via text prompts, tested in Beijing with promising results.


<details>
  <summary>Details</summary>
Motivation: Traditional top-down urban design methods often neglect public input, creating a gap between design aspirations and reality. Digital tools like City Information Modelling and augmented reality have begun to address this, but barriers remain.

Method: The paper proposes RECITYGEN, which integrates state-of-the-art latent diffusion models with interactive semantic segmentation, allowing users to generate variational street view images interactively using text prompts.

Result: In a pilot project in Beijing, RECITYGEN enabled users to suggest improvements for an Urban Regeneration project, demonstrating alignment with public preferences and potential for more inclusive urban planning.

Conclusion: RECITYGEN shows significant potential to bridge the gap between public input and urban design, fostering more dynamic and inclusive planning methods, despite some limitations.
...
### [21] [FADE: Selective Forgetting via Sparse LoRA and Self-Distillation](https://arxiv.org/abs/2602.07058)
*Carolina R. Kelsch,Leonardo S. B. Pereira,Natnael Mola,Luis H. Arribas,Juan C. S. M. Avedillo*

Main category: cs.CV

TL;DR: FADE is a two-stage unlearning method for image generation that combines parameter localization with self-distillation, achieving strong concept erasure and high retainability across various domains.


<details>
  <summary>Details</summary>
Motivation: Machine Unlearning is increasingly required by data protection regulations and responsible AI practices, but unlearning in text-to-image diffusion models remains challenging due to high computational costs and balancing effective forgetting with retention of unrelated concepts.

Method: FADE combines parameter localization with self-distillation, first identifying parameters responsible for the forget set using gradient-based saliency and then applying a self-distillation objective to overwrite the forgotten concept with a user-defined surrogate.

Result: FADE achieves State-of-the-Art unlearning performance with fine-grained control over the forgetting-retention trade-off, as demonstrated on the UnlearnCanvas benchmark and other datasets.

Conclusion: FADE demonstrates strong concept erasure and high retainability across various domains, making it a suitable solution for selective unlearning in diffusion-based image generation models.
...
### [22] [From Images to Decisions: Assistive Computer Vision for Non-Metallic Content Estimation in Scrap Metal](https://arxiv.org/abs/2602.07062)
*Daniil Storonkin,Ilia Dziub,Maksim Golyadkin,Ilya Makarov*

Main category: cs.CV

TL;DR: A computer vision pipeline estimates scrap contamination and classifies scrap type, reducing subjectivity and improving safety in steelmaking.


<details>
  <summary>Details</summary>
Motivation: Scrap quality directly affects energy use, emissions, and safety in steelmaking. Today, the share of non-metallic inclusions (contamination) is judged visually by inspectors - an approach that is subjective and hazardous due to dust and moving machinery.

Method: The method formulates contamination assessment as a regression task at the railcar level and leverages sequential data through multi-instance learning (MIL) and multi-task learning (MTL). Best results include MAE 0.27 and R2 0.83 by MIL; and an MTL setup reaches MAE 0.36 with F1 0.79 for scrap class.

Result: The pipeline reduces subjective variability, improves human safety, and enables integration into acceptance and melt-planning workflows.

Conclusion: The pipeline reduces subjective variability, improves human safety, and enables integration into acceptance and melt-planning workflows.
...
### [23] [Exploring Physical Intelligence Emergence via Omni-Modal Architecture and Physical Data Engine](https://arxiv.org/abs/2602.07064)
*Minghao Han,Dingkang Yang,Yue Jiang,Yizhou Liu,Lihua Zhang*

Main category: cs.CV

TL;DR: OmniFysics is a compact omni-modal model integrating images, audio, video, and text with speech and image generation, enhanced by a physical data engine for explicit physical knowledge injection.


<details>
  <summary>Details</summary>
Motivation: Physical understanding in omni-modal models is brittle due to visually ambiguous and sparsely represented physical attributes in web-scale data.

Method: The model uses a physical data engine (FysicsAny and FysicsOmniCap) for physics-grounded supervision and distillation, staged multimodal alignment, instruction tuning, latent-space flow matching for text-to-image generation, and an intent router for conditional generation.

Result: OmniFysics shows competitive performance on standard multimodal benchmarks and improved results on physics-oriented evaluations.

Conclusion: The integration of explicit physical knowledge through a dedicated data engine enhances the robustness and performance of omni-modal models in physics-oriented tasks.
...
### [24] [Contactless estimation of continuum displacement and mechanical compressibility from image series using a deep learning based framework](https://arxiv.org/abs/2602.07065)
*A. N. Maria Antony,T. Richter,E. Gladilin*

Main category: cs.CV

TL;DR: A deep learning-based end-to-end approach efficiently estimates continuum displacement and material compressibility from image series, outperforming traditional methods in accuracy and speed.


<details>
  <summary>Details</summary>
Motivation: Contactless and non-invasive estimation of mechanical properties from optical observations is crucial for engineering and biomedical applications where direct measurements are impractical.

Method: The approach uses two deep neural networks for image registration and material compressibility estimation, outperforming conventional methods like FEM and FDM in efficiency and accuracy.

Result: The experimental results show the model's high accuracy in determining material compressibility despite local deviations in displacement field predictions.

Conclusion: The deep learning end-to-end model demonstrates remarkable accuracy in estimating material compressibility, even with deviations in image registration predictions, due to its ability to assess higher-order cognitive features like vorticity.
...
TL;DR: Bird-SR is a bidirectional reward-guided diffusion framework for super-resolution that optimizes structural fidelity and perceptual quality via reward feedback learning, outperforming state-of-the-art methods on real-world benchmarks.


<details>
  <summary>Details</summary>
Motivation: Diffusion-based super-resolution models trained on synthetic paired data often fail on real-world LR images due to distribution shifts.

Method: Bird-SR is a bidirectional reward-guided diffusion framework that formulates super-resolution as trajectory-level preference optimization via reward feedback learning (ReFL), jointly leveraging synthetic LR-HR pairs and real-world LR images. It optimizes on synthetic pairs at early diffusion steps for structural fidelity and applies quality-guided rewards at later sampling steps for perceptual enhancement. A dynamic fidelity-perception weighting strategy is used to balance structural and perceptual learning.

Result: Extensive experiments on real-world SR benchmarks demonstrate that Bird-SR outperforms state-of-the-art methods in perceptual quality while preserving structural consistency.

Conclusion: Bird-SR consistently outperforms state-of-the-art methods in perceptual quality while preserving structural consistency, validating its effectiveness for real-world super-resolution.
...
TL;DR: MosaicThinker enhances on-device VLMs' spatial reasoning by integrating multi-frame spatial data into a unified semantic map, validated by improved accuracy in diverse tasks.


<details>
  <summary>Details</summary>
Motivation: Existing VLMs lack 3D spatial knowledge, leading to weak spatial reasoning capabilities, especially in complex multi-frame scenarios.

Method: The approach integrates fragmented spatial information from multiple frames into a unified global semantic map and uses visual prompts to guide the VLM's spatial reasoning.

Result: Experiments demonstrate that MosaicThinker greatly improves spatial reasoning accuracy on embodied AI devices.

Conclusion: The technique, MosaicThinker, significantly enhances the accuracy of cross-frame spatial reasoning on resource-constrained embodied AI devices across diverse and complex tasks.
...
TL;DR: TLC-Plan is a hierarchical generative model that directly synthesizes vector floorplans from input boundaries, achieving top performance on benchmark datasets.


<details>
  <summary>Details</summary>
Motivation: Existing approaches operate in raster space and rely on post hoc vectorization, which introduces structural inconsistencies and hinders end-to-end learning. The authors aim to align with human architectural workflows based on modular and reusable patterns.

Method: TLC-Plan employs a two-level VQ-VAE to encode global layouts as semantically labeled room bounding boxes and refines local geometries using polygon-level codes, unified in a CodeTree representation. An autoregressive transformer samples codes conditioned on the boundary to generate diverse and topologically valid designs.

Result: Extensive experiments show state-of-the-art performance on RPLAN dataset (FID = 1.84, MSE = 2.06) and leading results on LIFULL dataset.

Conclusion: The proposed TLC-Plan framework advances constraint-aware and scalable vector floorplan generation, achieving state-of-the-art performance on benchmark datasets.
...
TL;DR: PI3D is a physical prompt injection attack on MLLMs in 3D environments, bypassing current defenses.


<details>
  <summary>Details</summary>
Motivation: To explore the attack surface of MLLMs in 3D physical environments, where prior work focused on text and 2D image domains.

Method: The study introduces PI3D, a method for identifying effective 3D object poses with injected text to override MLLMs' intended tasks, ensuring physical plausibility.

Result: PI3D proves effective against multiple MLLMs across diverse camera trajectories, and existing defenses are shown to be inadequate.

Conclusion: PI3D demonstrates the vulnerability of MLLMs to physical prompt injection attacks in 3D environments, highlighting the insufficiency of existing defenses.
...
### [44] [Seeing Roads Through Words: A Language-Guided Framework for RGB-T Driving Scene Segmentation](https://arxiv.org/abs/2602.07343)
...
### [45] [Optimizing Few-Step Generation with Adaptive Matching Distillation](https://arxiv.org/abs/2602.07345)
...
### [46] [Row-Column Separated Attention Based Low-Light Image/Video Enhancement](https://arxiv.org/abs/2602.07428)
...
### [47] [Perspective-aware fusion of incomplete depth maps and surface normals for accurate 3D reconstruction](https://arxiv.org/abs/2602.07444)
...
### [48] [PTB-XL-Image-17K: A Large-Scale Synthetic ECG Image Dataset with Comprehensive Ground Truth for Deep Learning-Based Digitization](https://arxiv.org/abs/2602.07446)
*Naqcho Ali Mehdi*
...
### [49] [SoulX-FlashHead: Oracle-guided Generation of Infinite Real-time Streaming Talking Heads](https://arxiv.org/abs/2602.07449)
...
### [50] [SpatialReward: Bridging the Perception Gap in Online RL for Image Editing via Explicit Spatial Reasoning](https://arxiv.org/abs/2602.07458)
...
### [51] [GlobalWasteData: A Large-Scale, Integrated Dataset for Robust Waste Classification and Environmental Monitoring](https://arxiv.org/abs/2602.07463)
...
### [52] [Thermal odometry and dense mapping using learned ddometry and Gaussian splatting](https://arxiv.org/abs/2602.07493)
...
### [53] [Learning Brain Representation with Hierarchical Visual Embeddings](https://arxiv.org/abs/2602.07495)
...
### [54] [IM-Animation: An Implicit Motion Representation for Identity-decoupled Character Animation](https://arxiv.org/abs/2602.07498)
...
### [55] [Adaptive Image Zoom-in with Bounding Box Transformation for UAV Object Detection](https://arxiv.org/abs/2602.07512)
...
### [56] [CA-YOLO: Cross Attention Empowered YOLO for Biomimetic Localization](https://arxiv.org/abs/2602.07523)
...
### [57] [Evaluating Object-Centric Models beyond Object Discovery](https://arxiv.org/abs/2602.07532)
...
### [58] [Fine-Grained Cat Breed Recognition with Global Context Vision Transformer](https://arxiv.org/abs/2602.07534)
...
### [59] [Beyond Core and Penumbra: Bi-Temporal Image-Driven Stroke Evolution Analysis](https://arxiv.org/abs/2602.07535)
...
### [60] [LLM-Guided Diagnostic Evidence Alignment for Medical Vision-Language Pretraining under Limited Pairing](https://arxiv.org/abs/2602.07540)
...
### [63] [FlexID: Training-Free Flexible Identity Injection via Intent-Aware Modulation for Text-to-Image Generation](https://arxiv.org/abs/2602.07554)
...
### [64] [VISOR: VIsual Spatial Object Reasoning for Language-driven Object Navigation](https://arxiv.org/abs/2602.07555)
...
### [65] [SIGMA: Selective-Interleaved Generation with Multi-Attribute Tokens](https://arxiv.org/abs/2602.07564)
...
### [66] [Human Identification at a Distance: Challenges, Methods and Results on the Competition HID 2025](https://arxiv.org/abs/2602.07565)
...
### [67] [Cross-Camera Cow Identification via Disentangled Representation Learning](https://arxiv.org/abs/2602.07566)
...
### [68] [Visualizing the Invisible: Enhancing Radiologist Performance in Breast Mammography via Task-Driven Chromatic Encoding](https://arxiv.org/abs/2602.07568)
...
### [69] [ViCA: Efficient Multimodal LLMs with Vision-Only Cross-Attention](https://arxiv.org/abs/2602.07574)
...
### [70] [Automated rock joint trace mapping using a supervised learning model trained on synthetic data generated by parametric modelling](https://arxiv.org/abs/2602.07590)
...
### [71] [TeleBoost: A Systematic Alignment Framework for High-Fidelity, Controllable, and Robust Video Generation](https://arxiv.org/abs/2602.07595)
...
### [72] [Fine-R1: Make Multi-modal LLMs Excel in Fine-Grained Visual Recognition by Chain-of-Thought Reasoning](https://arxiv.org/abs/2602.07605)
...
### [73] [HistoMet: A Pan-Cancer Deep Learning Framework for Prognostic Prediction of Metastatic Progression and Site Tropism from Primary Tumor Histopathology](https://arxiv.org/abs/2602.07608)
...
### [74] [AD-MIR: Bridging the Gap from Perception to Persuasion in Advertising Video Understanding via Structured Reasoning](https://arxiv.org/abs/2602.07625)
...
### [75] [Uncovering Modality Discrepancy and Generalization Illusion for General-Purpose 3D Medical Segmentation](https://arxiv.org/abs/2602.07643)
...
### [76] [From Dead Pixels to Editable Slides: Infographic Reconstruction into Native Google Slides via Vision-Language Region Understanding](https://arxiv.org/abs/2602.07645)
*Leonardo Gonzalez*
...
### [77] [Influence of Geometry, Class Imbalance and Alignment on Reconstruction Accuracy -- A Micro-CT Phantom-Based Evaluation](https://arxiv.org/abs/2602.07658)
...
### [78] [Looking and Listening Inside and Outside: Multimodal Artificial Intelligence Systems for Driver Safety Assessment and Intelligent Vehicle Decision-Making](https://arxiv.org/abs/2602.07668)
...
### [79] [Vision and language: Novel Representations and Artificial intelligence for Driving Scene Safety Assessment and Autonomous Vehicle Planning](https://arxiv.org/abs/2602.07680)
...
### [80] [Process-of-Thought Reasoning for Videos](https://arxiv.org/abs/2602.07689)
...
### [81] [Semantic-Deviation-Anchored Multi-Branch Fusion for Unsupervised Anomaly Detection and Localization in Unstructured Conveyor-Belt Coal Scenes](https://arxiv.org/abs/2602.07694)
...
### [82] [A hybrid Kolmogorov-Arnold network for medical image segmentation](https://arxiv.org/abs/2602.07702)
...
### [83] [All-Optical Segmentation via Diffractive Neural Networks for Autonomous Driving](https://arxiv.org/abs/2602.07717)
...
### [84] [PAND: Prompt-Aware Neighborhood Distillation for Lightweight Fine-Grained Visual Classification](https://arxiv.org/abs/2602.07768)
...
### [85] [Rolling Sink: Bridging Limited-Horizon Training and Open-Ended Testing in Autoregressive Video Diffusion](https://arxiv.org/abs/2602.07775)
...
### [86] [Uncertainty-Aware Counterfactual Traffic Signal Control with Predictive Safety and Starvation-Avoidance Constraints Using Vision-Based Sensing](https://arxiv.org/abs/2602.07784)
...
### [87] [VideoTemp-o3: Harmonizing Temporal Grounding and Video Understanding in Agentic Thinking-with-Videos](https://arxiv.org/abs/2602.07801)
...
### [88] [How well are open sourced AI-generated image detection models out-of-the-box: A comprehensive benchmark study](https://arxiv.org/abs/2602.07814)
...
### [89] [Out of the box age estimation through facial imagery: A Comprehensive Benchmark of Vision-Language Models vs. out-of-the-box Traditional Architectures](https://arxiv.org/abs/2602.07815)
*Simiao Ren*
...
### [90] [Back to Physics: Operator-Guided Generative Paths for SMS MRI Reconstruction](https://arxiv.org/abs/2602.07820)
...
### [91] [Open-Text Aerial Detection: A Unified Framework For Aerial Visual Grounding And Detection](https://arxiv.org/abs/2602.07827)
...
### [92] [SPD-Faith Bench: Diagnosing and Improving Faithfulness in Chain-of-Thought for Multimodal Large Language Models](https://arxiv.org/abs/2602.07833)
...
### [93] [VFace: A Training-Free Approach for Diffusion-Based Video Face Swapping](https://arxiv.org/abs/2602.07835)
...
### [94] [Geometry-Aware Rotary Position Embedding for Consistent Video World Model](https://arxiv.org/abs/2602.07854)
...
### [95] [Recovering 3D Shapes from Ultra-Fast Motion-Blurred Images](https://arxiv.org/abs/2602.07860)
...
### [96] [Thinking in Structures: Evaluating Spatial Intelligence through Reasoning on Constrained Manifolds](https://arxiv.org/abs/2602.07864)
...
### [97] [WristMIR: Coarse-to-Fine Region-Aware Retrieval of Pediatric Wrist Radiographs with Radiology Report-Driven Learning](https://arxiv.org/abs/2602.07872)
...
### [98] [Scalable Adaptation of 3D Geometric Foundation Models via Weak Supervision from Internet Video](https://arxiv.org/abs/2602.07891)
...
### [99] [Rethinking Practical and Efficient Quantization Calibration for Vision-Language Models](https://arxiv.org/abs/2602.07899)
...
### [100] [Which private attributes do VLMs agree on and predict well?](https://arxiv.org/abs/2602.07931)
...
### [101] [Integrating Specialized and Generic Agent Motion Prediction with Dynamic Occupancy Grid Maps](https://arxiv.org/abs/2602.07938)
...
### [102] [One-Shot Crowd Counting With Density Guidance For Scene Adaptaion](https://arxiv.org/abs/2602.07955)
...
### [103] [D-ORCA: Dialogue-Centric Optimization for Robust Audio-Visual Captioning](https://arxiv.org/abs/2602.07960)
...
### [104] [EasyTune: Efficient Step-Aware Fine-Tuning for Diffusion-Based Motion Generation](https://arxiv.org/abs/2602.07967)
...
### [105] [FSP-Diff: Full-Spectrum Prior-Enhanced DualDomain Latent Diffusion for Ultra-Low-Dose Spectral CT Reconstruction](https://arxiv.org/abs/2602.07979)
...
### [106] [Continuity-driven Synergistic Diffusion with Neural Priors for Ultra-Sparse-View CBCT Reconstruction](https://arxiv.org/abs/2602.07980)
...
### [107] [Deepfake Synthesis vs. Detection: An Uneven Contest](https://arxiv.org/abs/2602.07986)
...
### [108] [MCIE: Multimodal LLM-Driven Complex Instruction Image Editing with Spatial Guidance](https://arxiv.org/abs/2602.07993)
...
### [109] [ForecastOcc: Vision-based Semantic Occupancy Forecasting](https://arxiv.org/abs/2602.08006)
...
### [110] [PhysDrape: Learning Explicit Forces and Collision Constraints for Physically Realistic Garment Draping](https://arxiv.org/abs/2602.08020)
...
### [112] [MIND: Benchmarking Memory Consistency and Action Control in World Models](https://arxiv.org/abs/2602.08025)
...
### [113] [Enhanced Mixture 3D CGAN for Completion and Generation of 3D Objects](https://arxiv.org/abs/2602.08046)
...
### [114] [Vanilla Group Equivariant Vision Transformer: Simple and Effective](https://arxiv.org/abs/2602.08047)
...
### [115] [Weak to Strong: VLM-Based Pseudo-Labeling as a Weakly Supervised Training Strategy in Multimodal Video-based Hidden Emotion Understanding Tasks](https://arxiv.org/abs/2602.08057)
...
### [116] [Picasso: Holistic Scene Reconstruction with Physics-Constrained Sampling](https://arxiv.org/abs/2602.08058)
...
### [117] [DICE: Disentangling Artist Style from Content via Contrastive Subspace Decomposition in Diffusion Models](https://arxiv.org/abs/2602.08059)
...
### [118] [ReRoPE: Repurposing RoPE for Relative Camera Control](https://arxiv.org/abs/2602.08068)
...
### [119] [ViT-5: Vision Transformers for The Mid-2020s](https://arxiv.org/abs/2602.08071)
...
### [120] [VidVec: Unlocking Video MLLM Embeddings for Video-Text Retrieval](https://arxiv.org/abs/2602.08099)
...
### [121] [MMLSv2: A Multimodal Dataset for Martian Landslide Detection in Remote Sensing Imagery](https://arxiv.org/abs/2602.08112)
...
### [122] [Building Damage Detection using Satellite Images and Patch-Based Transformer Methods](https://arxiv.org/abs/2602.08117)
...
### [123] [MambaFusion: Adaptive State-Space Fusion for Multimodal 3D Object Detection](https://arxiv.org/abs/2602.08126)
...
### [124] [Fields of The World: A Field Guide for Extracting Agricultural Field Boundaries](https://arxiv.org/abs/2602.08131)
...
### [125] [Robustness of Vision Language Models Against Split-Image Harmful Input Attacks](https://arxiv.org/abs/2602.08136)
...
### [126] [DAS-SK: An Adaptive Model Integrating Dual Atrous Separable and Selective Kernel CNN for Agriculture Semantic Segmentation](https://arxiv.org/abs/2602.08168)
...
### [127] [PEGAsus: 3D Personalization of Geometry and Appearance](https://arxiv.org/abs/2602.08198)
...
### [128] [Generative Regression for Left Ventricular Ejection Fraction Estimation from Echocardiography Video](https://arxiv.org/abs/2602.08202)
...
### [129] [Geospatial-Reasoning-Driven Vocabulary-Agnostic Remote Sensing Semantic Segmentation](https://arxiv.org/abs/2602.08206)
...
### [130] [Chain-of-Caption: Training-free improvement of multimodal large language model on referring expression comprehension](https://arxiv.org/abs/2602.08211)
...
### [131] [Efficient-SAM2: Accelerating SAM2 with Object-Aware Visual Encoding and Memory Retrieval](https://arxiv.org/abs/2602.08224)
...
### [157] [GOT-Edit: Geometry-Aware Generic Object Tracking via Online Model Editing](https://arxiv.org/abs/2602.08550)
...
### [158] [FLAG-4D: Flow-Guided Local-Global Dual-Deformation Model for 4D Reconstruction](https://arxiv.org/abs/2602.08558)
...
### [159] [SemiNFT: Learning to Transfer Presets from Imitation to Appreciation via Hybrid-Sample Reinforcement Learning](https://arxiv.org/abs/2602.08582)
...
### [160] [Overview and Comparison of AVS Point Cloud Compression Standard](https://arxiv.org/abs/2602.08613)
...
### [161] [Inspiration Seeds: Learning Non-Literal Visual Combinations for Generative Exploration](https://arxiv.org/abs/2602.08615)
...
### [162] [Improving Reconstruction of Representation Autoencoder](https://arxiv.org/abs/2602.08620)
...
### [163] [Revisiting [CLS] and Patch Token Interaction in Vision Transformers](https://arxiv.org/abs/2602.08626)
...
### [164] [Deep Learning-Based Fixation Type Prediction for Quality Assurance in Digital Pathology](https://arxiv.org/abs/2602.08652)
...
### [165] [WiFlow: A Lightweight WiFi-based Continuous Human Pose Estimation Network with Spatio-Temporal Feature Decoupling](https://arxiv.org/abs/2602.08661)
...
### [166] [A Machine Learning accelerated geophysical fluid solver](https://arxiv.org/abs/2602.08670)
*Yang Bai*
...
### [167] [ALIVE: Animate Your World with Lifelike Audio-Video Generation](https://arxiv.org/abs/2602.08682)
...
### [168] [OneVision-Encoder: Codec-Aligned Sparsity as a Foundational Principle for Multimodal Intelligence](https://arxiv.org/abs/2602.08683)
...
### [169] [Low-Light Video Enhancement with An Effective Spatial-Temporal Decomposition Paradigm](https://arxiv.org/abs/2602.08699)
...
### [170] [TimeChat-Captioner: Scripting Multi-Scene Videos with Time-Aware and Structural Audio-Visual Captions](https://arxiv.org/abs/2602.08711)
...
### [171] [Towards Understanding Multimodal Fine-Tuning: Spatial Features](https://arxiv.org/abs/2602.08713)
...
### [172] [Zero-shot System for Automatic Body Region Detection for Volumetric CT and MR Images](https://arxiv.org/abs/2602.08717)
...
### [173] [Rotated Lights for Consistent and Efficient 2D Gaussians Inverse Rendering](https://arxiv.org/abs/2602.08724)
...
### [174] [FusionEdit: Semantic Fusion and Attention Modulation for Training-Free Image Editing](https://arxiv.org/abs/2602.08725)
...
### [175] [SynSacc: A Blender-to-V2E Pipeline for Synthetic Neuromorphic Eye-Movement Data and Sim-to-Real Spiking Model Training](https://arxiv.org/abs/2602.08726)
...
### [176] [Artifact Reduction in Undersampled 3D Cone-Beam CTs using a Hybrid 2D-3D CNN Framework](https://arxiv.org/abs/2602.08727)
...
### [177] [Closing the Confusion Loop: CLIP-Guided Alignment for Source-Free Domain Adaptation](https://arxiv.org/abs/2602.08730)
...
### [178] [From Correspondence to Actions: Human-Like Multi-Image Spatial Reasoning in Multi-modal Large Language Models](https://arxiv.org/abs/2602.08735)
...
### [179] [Shifting the Breaking Point of Flow Matching for Multi-Instance Editing](https://arxiv.org/abs/2602.08749)
...
### [180] [MVAnimate: Enhancing Character Animation with Multi-View Optimization](https://arxiv.org/abs/2602.08753)
...
### [181] [VedicTHG: Symbolic Vedic Computation for Low-Resource Talking-Head Generation in Educational Avatars](https://arxiv.org/abs/2602.08775)
...
### [182] [Multimodal Learning for Arcing Detection in Pantograph-Catenary Systems](https://arxiv.org/abs/2602.08792)
...
### [184] [Addressing data annotation scarcity in Brain Tumor Segmentation on 3D MRI scan Using a Semi-Supervised Teacher-Student Framework](https://arxiv.org/abs/2602.08797)
...
### [185] [Omni-Video 2: Scaling MLLM-Conditioned Diffusion for Unified Video Generation and Editing](https://arxiv.org/abs/2602.08820)
...
### [186] [Any-to-All MRI Synthesis: A Unified Foundation Model for Nasopharyngeal Carcinoma and Its Downstream Applications](https://arxiv.org/abs/2602.08822)
...
### [187] [VideoVeritas: AI-Generated Video Detection via Perception Pretext Reinforcement Learning](https://arxiv.org/abs/2602.08828)
...
### [188] [FlattenGPT: Depth Compression for Transformer with Layer Flattening](https://arxiv.org/abs/2602.08858)
...
### [189] [TiFRe: Text-guided Video Frame Reduction for Efficient Video Multi-modal Large Language Models](https://arxiv.org/abs/2602.08861)
...
### [190] [Analysis of Converged 3D Gaussian Splatting Solutions: Density Effects and Prediction Limit](https://arxiv.org/abs/2602.08909)
...
### [191] [Grow with the Flow: 4D Reconstruction of Growing Plants with Gaussian Flow Fields](https://arxiv.org/abs/2602.08958)
...
### [192] [MotionCrafter: Dense Geometry and Motion Reconstruction with a 4D VAE](https://arxiv.org/abs/2602.08961)
...
### [193] [Modeling 3D Pedestrian-Vehicle Interactions for Vehicle-Conditioned Pose Forecasting](https://arxiv.org/abs/2602.08962)
...
### [194] [WorldArena: A Unified Benchmark for Evaluating Perception and Functional Utility of Embodied World Models](https://arxiv.org/abs/2602.08971)
...
### [195] [Generalizing Sports Feedback Generation by Watching Competitions and Reading Books: A Rock Climbing Case Study](https://arxiv.org/abs/2602.08996)
...
### [196] [ArcFlow: Unleashing 2-Step Text-to-Image Generation via High-Precision Non-Linear Flow Distillation](https://arxiv.org/abs/2602.09014)
...
### [197] [Raster2Seq: Polygon Sequence Generation for Floorplan Reconstruction](https://arxiv.org/abs/2602.09016)
...
### [198] [WorldCompass: Reinforcement Learning for Long-Horizon World Models](https://arxiv.org/abs/2602.09022)
...
### [199] [Autoregressive Image Generation with Masked Bit Modeling](https://arxiv.org/abs/2602.09024)
